...
/**
 * This is the action bar contributor for the Dynamic model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DynamicActionBarContributor extends EditingDomainActionBarContributor
	 ...
	 * @generated
	 */
	public DynamicActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("dynamic-settings"));
		toolBarManager.add(new Separator("dynamic-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(Bpmn2EditorPlugin.INSTANCE.getString("_UI_DynamicEditor_menu"),
				"org.obeonetwork.dsl.bpmn2.dynamicMenuID");
