...
public class CompensateEventDefinitionAdapter extends EObjectAdapter<CompensateEventDefinition> implements org.obeonetwork.dsl.bpmn2.CompensateEventDefinition {
  ...
  @Override
  public org.obeonetwork.dsl.bpmn2.Activity getActivityRef() {
    return () adaptersFactory.createAdapter(adaptee.getActivityRef(), eResource);
  }
  
  @Override
  public void setActivityRef(final org.obeonetwork.dsl.bpmn2.Activity o) {
    if (o != null)
    	adaptee.setActivityRef(((org.gemoc.bpmn2.xbpmn.xbpmn.adapters.bpmnmt.bpmn2.ActivityAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getCompensateEventDefinition();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.COMPENSATE_EVENT_DEFINITION__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.COMPENSATE_EVENT_DEFINITION__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.COMPENSATE_EVENT_DEFINITION__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.COMPENSATE_EVENT_DEFINITION__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.COMPENSATE_EVENT_DEFINITION__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.COMPENSATE_EVENT_DEFINITION__WAIT_FOR_COMPLETION:
    		return isWaitForCompletion() ? Boolean.TRUE : Boolean.FALSE;
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.COMPENSATE_EVENT_DEFINITION__ACTIVITY_REF:
