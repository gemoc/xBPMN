...
public class SequenceFlowAdapter extends EObjectAdapter<SequenceFlow> implements org.obeonetwork.dsl.bpmn2.SequenceFlow {
  ...
  @Override
  public org.obeonetwork.dsl.bpmn2.Expression getConditionExpression() {
    return () adaptersFactory.createAdapter(adaptee.getConditionExpression(), eResource);
  }
  
  @Override
  public void setConditionExpression(final org.obeonetwork.dsl.bpmn2.Expression o) {
    if (o != null)
    	adaptee.setConditionExpression(((org.gemoc.bpmn2.xbpmn.xbpmn.adapters.bpmnmt.bpmn2.ExpressionAdapter) o).getAdaptee());
    else adaptee.setConditionExpression(null);
  }
  
  @Override
  public org.obeonetwork.dsl.bpmn2.FlowNode getTargetRef() {
    return () adaptersFactory.createAdapter(adaptee.getTargetRef(), eResource);
  }
  
  @Override
  public void setTargetRef(final org.obeonetwork.dsl.bpmn2.FlowNode o) {
    if (o != null)
    	adaptee.setTargetRef(((org.gemoc.bpmn2.xbpmn.xbpmn.adapters.bpmnmt.bpmn2.FlowNodeAdapter) o).getAdaptee());
    else adaptee.setTargetRef(null);
  }
  
  @Override
  public org.obeonetwork.dsl.bpmn2.FlowNode getSourceRef() {
    return () adaptersFactory.createAdapter(adaptee.getSourceRef(), eResource);
  }
  
  @Override
  public void setSourceRef(final org.obeonetwork.dsl.bpmn2.FlowNode o) {
    if (o != null)
    	adaptee.setSourceRef(((org.gemoc.bpmn2.xbpmn.xbpmn.adapters.bpmnmt.bpmn2.FlowNodeAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getSequenceFlow();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__NAME:
    		return getName();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__AUDITING:
    		return getAuditing();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__MONITORING:
    		return getMonitoring();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__CATEGORY_VALUE_REF:
    		return getCategoryValueRef();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__IS_IMMEDIATE:
    		return isIsImmediate() ? Boolean.TRUE : Boolean.FALSE;
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__CONDITION_EXPRESSION:
    		return getConditionExpression();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__TARGET_REF:
    		return getTargetRef();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__SOURCE_REF:
    		return getSourceRef();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__TARGET_REF:
    		setTargetRef(
    		(org.obeonetwork.dsl.bpmn2.FlowNode)
    		 newValue);
    		return;
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SEQUENCE_FLOW__SOURCE_REF:
    		setSourceRef(
