...
public class EventBasedGatewayAdapter extends EObjectAdapter<EventBasedGateway> implements org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.EventBasedGateway {
  ...
  @Override
  public org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.EventBasedGatewayType getEventGatewayType() {
    return org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.EventBasedGatewayType.get(adaptee.getEventGatewayType().getValue());
  }
  
  @Override
  public void setEventGatewayType(final org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.EventBasedGatewayType o) {
  ...
  protected static final org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.EventBasedGatewayType EVENT_GATEWAY_TYPE_EDEFAULT = org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.EventBasedGatewayType.PARALLEL;
  
  @Override
  public EClass eClass() {
    return org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.eINSTANCE.getEventBasedGateway();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__ID:
    		return getId();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__DOCUMENTATION:
    		return getDocumentation();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__NAME:
    		return getName();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__AUDITING:
    		return getAuditing();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__MONITORING:
    		return getMonitoring();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__CATEGORY_VALUE_REF:
    		return getCategoryValueRef();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__OUTGOING:
    		return getOutgoing();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__INCOMING:
    		return getIncoming();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__LANES:
    		return getLanes();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__GATEWAY_DIRECTION:
    		return getGatewayDirection();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__INSTANTIATE:
    		return isInstantiate() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__EVENT_GATEWAY_TYPE:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.EVENT_BASED_GATEWAY__EVENT_GATEWAY_TYPE:
    		setEventGatewayType(
    		(org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.EventBasedGatewayType)
    		 newValue);
    		return;
    }
