...
public class StandardLoopCharacteristicsAdapter extends EObjectAdapter<StandardLoopCharacteristics> implements org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.StandardLoopCharacteristics {
  ...
  @Override
  public org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Expression getLoopCondition() {
    return () adaptersFactory.createAdapter(adaptee.getLoopCondition(), eResource);
  }
  
  @Override
  public void setLoopCondition(final org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Expression o) {
    if (o != null)
    	adaptee.setLoopCondition(((org.gemoc.bpmn2.xbpmn.xbpmn.adapters.xbpmnmt.bpmn2.ExpressionAdapter) o).getAdaptee());
    else adaptee.setLoopCondition(null);
  }
  
  @Override
  public org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Expression getLoopMaximum() {
    return () adaptersFactory.createAdapter(adaptee.getLoopMaximum(), eResource);
  }
  
  @Override
  public void setLoopMaximum(final org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Expression o) {
    if (o != null)
    	adaptee.setLoopMaximum(((org.gemoc.bpmn2.xbpmn.xbpmn.adapters.xbpmnmt.bpmn2.ExpressionAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.eINSTANCE.getStandardLoopCharacteristics();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.STANDARD_LOOP_CHARACTERISTICS__ID:
    		return getId();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.STANDARD_LOOP_CHARACTERISTICS__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.STANDARD_LOOP_CHARACTERISTICS__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.STANDARD_LOOP_CHARACTERISTICS__DOCUMENTATION:
    		return getDocumentation();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.STANDARD_LOOP_CHARACTERISTICS__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.STANDARD_LOOP_CHARACTERISTICS__TEST_BEFORE:
    		return isTestBefore() ? Boolean.TRUE : Boolean.FALSE;
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.STANDARD_LOOP_CHARACTERISTICS__LOOP_CONDITION:
    		return getLoopCondition();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.STANDARD_LOOP_CHARACTERISTICS__LOOP_MAXIMUM:
