...
public class SubProcessAdapter extends EObjectAdapter<SubProcess> implements org.obeonetwork.dsl.bpmn2.SubProcess {
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getSubProcess();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__NAME:
    		return getName();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__AUDITING:
    		return getAuditing();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__MONITORING:
    		return getMonitoring();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__CATEGORY_VALUE_REF:
    		return getCategoryValueRef();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__OUTGOING:
    		return getOutgoing();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__INCOMING:
    		return getIncoming();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__LANES:
    		return getLanes();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__INCOMING_CONVERSATION_LINKS:
    		return getIncomingConversationLinks();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__OUTGOING_CONVERSATION_LINKS:
    		return getOutgoingConversationLinks();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__IS_FOR_COMPENSATION:
    		return isIsForCompensation() ? Boolean.TRUE : Boolean.FALSE;
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__LOOP_CHARACTERISTICS:
    		return getLoopCharacteristics();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__RESOURCES:
    		return getResources();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__DEFAULT:
    		return getDefault();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__PROPERTIES:
    		return getProperties();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__IO_SPECIFICATION:
    		return getIoSpecification();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__BOUNDARY_EVENT_REFS:
    		return getBoundaryEventRefs();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__DATA_INPUT_ASSOCIATIONS:
    		return getDataInputAssociations();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__DATA_OUTPUT_ASSOCIATIONS:
    		return getDataOutputAssociations();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__START_QUANTITY:
    		return new java.lang.Integer(getStartQuantity());
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__COMPLETION_QUANTITY:
    		return new java.lang.Integer(getCompletionQuantity());
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__FLOW_ELEMENTS:
    		return getFlowElements();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__LANE_SETS:
    		return getLaneSets();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__TRIGGERED_BY_EVENT:
    		return isTriggeredByEvent() ? Boolean.TRUE : Boolean.FALSE;
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__ARTIFACTS:
    		return getArtifacts();
    }
    ...
    if (baseClass == org.obeonetwork.dsl.bpmn2.FlowElementsContainer.class) {
    	switch (baseFeatureID) {
    		case org.obeonetwork.dsl.bpmn2.Bpmn2Package.FLOW_ELEMENTS_CONTAINER__FLOW_ELEMENTS:
    			return org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__FLOW_ELEMENTS;
    		case org.obeonetwork.dsl.bpmn2.Bpmn2Package.FLOW_ELEMENTS_CONTAINER__LANE_SETS:
    			return org.obeonetwork.dsl.bpmn2.Bpmn2Package.SUB_PROCESS__LANE_SETS;
    		default: return -1;
    	}
    }
