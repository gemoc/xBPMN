...
public class OperationAdapter extends EObjectAdapter<Operation> implements org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Operation {
  ...
  @Override
  public org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Message getInMessageRef() {
    return () adaptersFactory.createAdapter(adaptee.getInMessageRef(), eResource);
  }
  
  @Override
  public void setInMessageRef(final org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Message o) {
    if (o != null)
    	adaptee.setInMessageRef(((org.gemoc.bpmn2.xbpmn.xbpmn.adapters.xbpmnmt.bpmn2.MessageAdapter) o).getAdaptee());
    else adaptee.setInMessageRef(null);
  }
  
  @Override
  public org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Message getOutMessageRef() {
    return () adaptersFactory.createAdapter(adaptee.getOutMessageRef(), eResource);
  }
  
  @Override
  public void setOutMessageRef(final org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Message o) {
    if (o != null)
    	adaptee.setOutMessageRef(((org.gemoc.bpmn2.xbpmn.xbpmn.adapters.xbpmnmt.bpmn2.MessageAdapter) o).getAdaptee());
    else adaptee.setOutMessageRef(null);
  }
  
  private /* EList<org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Error> */Object errorRefs_;
  
  @Override
  public /* EList<org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Error> */Object getErrorRefs() {
    if (errorRefs_ == null)
  ...
  public EClass eClass() {
    return org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.eINSTANCE.getOperation();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.OPERATION__ID:
    		return getId();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.OPERATION__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.OPERATION__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.OPERATION__DOCUMENTATION:
    		return getDocumentation();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.OPERATION__DESCRIPTION:
    		return getDescription();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.OPERATION__NAME:
    		return getName();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.OPERATION__IN_MESSAGE_REF:
    		return getInMessageRef();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.OPERATION__OUT_MESSAGE_REF:
    		return getOutMessageRef();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.OPERATION__ERROR_REFS:
    		return getErrorRefs();
    	case org.gemoc.bpmn2.xbpmn.xbpmnmt.bpmn2.Bpmn2Package.OPERATION__IMPLEMENTATION_REF:
