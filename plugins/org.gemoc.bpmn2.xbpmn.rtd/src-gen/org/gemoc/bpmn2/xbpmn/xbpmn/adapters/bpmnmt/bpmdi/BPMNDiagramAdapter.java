...
public class BPMNDiagramAdapter extends EObjectAdapter<BPMNDiagram> implements org.obeonetwork.dsl.bpmn2.bpmdi.BPMNDiagram {
  ...
  @Override
  public org.obeonetwork.dsl.bpmn2.bpmdi.BPMNPlane getPlane() {
    return () adaptersFactory.createAdapter(adaptee.getPlane(), eResource);
  }
  
  @Override
  public void setPlane(final org.obeonetwork.dsl.bpmn2.bpmdi.BPMNPlane o) {
    if (o != null)
    	adaptee.setPlane(((org.gemoc.bpmn2.xbpmn.xbpmn.adapters.bpmnmt.bpmdi.BPMNPlaneAdapter) o).getAdaptee());
    else adaptee.setPlane(null);
  }
  
  private /* EList<org.obeonetwork.dsl.bpmn2.bpmdi.BPMNLabelStyle> */Object labelStyle_;
  
  @Override
  public /* EList<org.obeonetwork.dsl.bpmn2.bpmdi.BPMNLabelStyle> */Object getLabelStyle() {
    if (labelStyle_ == null)
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.bpmdi.BpmnDiPackage.eINSTANCE.getBPMNDiagram();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.bpmdi.BpmnDiPackage.BPMN_DIAGRAM__NAME:
    		return getName();
    	case org.obeonetwork.dsl.bpmn2.bpmdi.BpmnDiPackage.BPMN_DIAGRAM__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.bpmdi.BpmnDiPackage.BPMN_DIAGRAM__RESOLUTION:
    		return new java.lang.Float(getResolution());
    	case org.obeonetwork.dsl.bpmn2.bpmdi.BpmnDiPackage.BPMN_DIAGRAM__OWNED_STYLE:
    		return getOwnedStyle();
    	case org.obeonetwork.dsl.bpmn2.bpmdi.BpmnDiPackage.BPMN_DIAGRAM__ROOT_ELEMENT:
    		return getRootElement();
    	case org.obeonetwork.dsl.bpmn2.bpmdi.BpmnDiPackage.BPMN_DIAGRAM__PLANE:
    		return getPlane();
    	case org.obeonetwork.dsl.bpmn2.bpmdi.BpmnDiPackage.BPMN_DIAGRAM__LABEL_STYLE:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.obeonetwork.dsl.bpmn2.bpmdi.BpmnDiPackage.BPMN_DIAGRAM__PLANE:
    		setPlane(
    		(org.obeonetwork.dsl.bpmn2.bpmdi.BPMNPlane)
    		 newValue);
    		return;
    	case org.obeonetwork.dsl.bpmn2.bpmdi.BpmnDiPackage.BPMN_DIAGRAM__LABEL_STYLE:
    		getLabelStyle().clear();
