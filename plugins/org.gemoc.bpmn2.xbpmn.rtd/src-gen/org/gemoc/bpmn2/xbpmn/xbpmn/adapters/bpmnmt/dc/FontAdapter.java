...
public class FontAdapter extends EObjectAdapter<Font> implements org.obeonetwork.dsl.dd.dc.Font {
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.dd.dc.DcPackage.eINSTANCE.getFont();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.dd.dc.DcPackage.FONT__NAME:
    		return getName();
    	case org.obeonetwork.dsl.dd.dc.DcPackage.FONT__SIZE:
    		return new java.lang.Float(getSize());
    	case org.obeonetwork.dsl.dd.dc.DcPackage.FONT__IS_BOLD:
    		return isIsBold() ? Boolean.TRUE : Boolean.FALSE;
    	case org.obeonetwork.dsl.dd.dc.DcPackage.FONT__IS_ITALIC:
    		return isIsItalic() ? Boolean.TRUE : Boolean.FALSE;
    	case org.obeonetwork.dsl.dd.dc.DcPackage.FONT__IS_UNDERLINE:
    		return isIsUnderline() ? Boolean.TRUE : Boolean.FALSE;
    	case org.obeonetwork.dsl.dd.dc.DcPackage.FONT__IS_STRIKE_THROUGH:
