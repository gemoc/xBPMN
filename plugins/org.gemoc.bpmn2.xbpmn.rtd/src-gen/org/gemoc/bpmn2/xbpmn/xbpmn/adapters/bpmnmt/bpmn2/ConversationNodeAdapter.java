...
public class ConversationNodeAdapter extends EObjectAdapter<ConversationNode> implements org.obeonetwork.dsl.bpmn2.ConversationNode {
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getConversationNode();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__INCOMING_CONVERSATION_LINKS:
    		return getIncomingConversationLinks();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__OUTGOING_CONVERSATION_LINKS:
    		return getOutgoingConversationLinks();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__NAME:
    		return getName();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__PARTICIPANT_REFS:
    		return getParticipantRefs();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__MESSAGE_FLOW_REFS:
    		return getMessageFlowRefs();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__CORRELATION_KEYS:
    ...
    if (baseClass == org.obeonetwork.dsl.bpmn2.InteractionNode.class) {
    	switch (baseFeatureID) {
    		case org.obeonetwork.dsl.bpmn2.Bpmn2Package.INTERACTION_NODE__INCOMING_CONVERSATION_LINKS:
    			return org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__INCOMING_CONVERSATION_LINKS;
    		case org.obeonetwork.dsl.bpmn2.Bpmn2Package.INTERACTION_NODE__OUTGOING_CONVERSATION_LINKS:
    			return org.obeonetwork.dsl.bpmn2.Bpmn2Package.CONVERSATION_NODE__OUTGOING_CONVERSATION_LINKS;
    		default: return -1;
    	}
    }
