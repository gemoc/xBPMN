...
public class DataStoreAdapter extends EObjectAdapter<DataStore> implements org.obeonetwork.dsl.bpmn2.DataStore {
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getDataStore();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.DATA_STORE__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.DATA_STORE__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.DATA_STORE__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.DATA_STORE__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.DATA_STORE__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.DATA_STORE__ITEM_SUBJECT_REF:
    		return getItemSubjectRef();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.DATA_STORE__DATA_STATE:
    		return getDataState();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.DATA_STORE__NAME:
    		return getName();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.DATA_STORE__CAPACITY:
    		return new java.lang.Integer(getCapacity());
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.DATA_STORE__IS_UNLIMITED:
