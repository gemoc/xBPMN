...
public class GlobalConversationAdapter extends EObjectAdapter<GlobalConversation> implements org.obeonetwork.dsl.bpmn2.GlobalConversation {
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getGlobalConversation();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__NAME:
    		return getName();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__IS_CLOSED:
    		return isIsClosed() ? Boolean.TRUE : Boolean.FALSE;
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__CHOREOGRAPHY_REF:
    		return getChoreographyRef();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__ARTIFACTS:
    		return getArtifacts();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__PARTICIPANT_ASSOCIATIONS:
    		return getParticipantAssociations();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__MESSAGE_FLOW_ASSOCIATIONS:
    		return getMessageFlowAssociations();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__CONVERSATION_ASSOCIATIONS:
    		return getConversationAssociations();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__PARTICIPANTS:
    		return getParticipants();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__MESSAGE_FLOWS:
    		return getMessageFlows();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__CORRELATION_KEYS:
    		return getCorrelationKeys();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__CONVERSATIONS:
    		return getConversations();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_CONVERSATION__CONVERSATION_LINKS:
