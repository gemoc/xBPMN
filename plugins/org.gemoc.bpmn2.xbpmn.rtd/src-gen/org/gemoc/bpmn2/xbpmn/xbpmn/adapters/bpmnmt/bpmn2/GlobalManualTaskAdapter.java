...
public class GlobalManualTaskAdapter extends EObjectAdapter<GlobalManualTask> implements org.obeonetwork.dsl.bpmn2.GlobalManualTask {
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getGlobalManualTask();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_MANUAL_TASK__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_MANUAL_TASK__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_MANUAL_TASK__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_MANUAL_TASK__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_MANUAL_TASK__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_MANUAL_TASK__NAME:
    		return getName();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_MANUAL_TASK__IO_SPECIFICATION:
    		return getIoSpecification();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_MANUAL_TASK__SUPPORTED_INTERFACE_REFS:
    		return getSupportedInterfaceRefs();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_MANUAL_TASK__IO_BINDING:
    		return getIoBinding();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.GLOBAL_MANUAL_TASK__RESOURCES:
    		return getResources();
    }
