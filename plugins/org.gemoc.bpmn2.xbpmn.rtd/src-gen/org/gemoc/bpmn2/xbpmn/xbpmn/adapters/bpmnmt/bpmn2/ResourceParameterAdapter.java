...
public class ResourceParameterAdapter extends EObjectAdapter<ResourceParameter> implements org.obeonetwork.dsl.bpmn2.ResourceParameter {
  private BPMNMTAdaptersFactory adaptersFactory;
  
  public ResourceParameterAdapter() {
  ...
  public boolean isIsRequired() {
    return adaptee.isIsRequired();
  }
  
  @Override
  public void setIsRequired(final boolean o) {
    adaptee.setIsRequired(o);
  }
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getResourceParameter();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.RESOURCE_PARAMETER__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.RESOURCE_PARAMETER__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.RESOURCE_PARAMETER__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.RESOURCE_PARAMETER__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.RESOURCE_PARAMETER__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.RESOURCE_PARAMETER__NAME:
    		return getName();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.RESOURCE_PARAMETER__IS_REQUIRED:
    		return isIsRequired() ? Boolean.TRUE : Boolean.FALSE;
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.RESOURCE_PARAMETER__TYPE:
    		return getType();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.RESOURCE_PARAMETER__NAME:
    		...
    		return;
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.RESOURCE_PARAMETER__IS_REQUIRED:
    		setIsRequired(((java.lang.Boolean) newValue).booleanValue());
    		return;
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.RESOURCE_PARAMETER__TYPE:
    		setType(
