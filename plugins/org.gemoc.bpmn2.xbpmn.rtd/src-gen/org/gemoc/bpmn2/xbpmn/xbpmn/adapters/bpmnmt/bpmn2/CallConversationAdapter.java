...
public class CallConversationAdapter extends EObjectAdapter<CallConversation> implements org.obeonetwork.dsl.bpmn2.CallConversation {
  ...
  @Override
  public org.obeonetwork.dsl.bpmn2.Collaboration getCalledCollaborationRef() {
    return () adaptersFactory.createAdapter(adaptee.getCalledCollaborationRef(), eResource);
  }
  
  @Override
  public void setCalledCollaborationRef(final org.obeonetwork.dsl.bpmn2.Collaboration o) {
    if (o != null)
    	adaptee.setCalledCollaborationRef(((org.gemoc.bpmn2.xbpmn.xbpmn.adapters.bpmnmt.bpmn2.CollaborationAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getCallConversation();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__INCOMING_CONVERSATION_LINKS:
    		return getIncomingConversationLinks();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__OUTGOING_CONVERSATION_LINKS:
    		return getOutgoingConversationLinks();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__NAME:
    		return getName();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__PARTICIPANT_REFS:
    		return getParticipantRefs();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__MESSAGE_FLOW_REFS:
    		return getMessageFlowRefs();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__CORRELATION_KEYS:
    		return getCorrelationKeys();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__CALLED_COLLABORATION_REF:
    		return getCalledCollaborationRef();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALL_CONVERSATION__PARTICIPANT_ASSOCIATIONS:
