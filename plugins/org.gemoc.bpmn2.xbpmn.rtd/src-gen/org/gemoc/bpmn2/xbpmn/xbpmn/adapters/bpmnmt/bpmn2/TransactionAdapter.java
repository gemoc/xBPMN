...
public class TransactionAdapter extends EObjectAdapter<Transaction> implements org.obeonetwork.dsl.bpmn2.Transaction {
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getTransaction();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__NAME:
    		return getName();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__AUDITING:
    		return getAuditing();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__MONITORING:
    		return getMonitoring();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__CATEGORY_VALUE_REF:
    		return getCategoryValueRef();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__OUTGOING:
    		return getOutgoing();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__INCOMING:
    		return getIncoming();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__LANES:
    		return getLanes();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__INCOMING_CONVERSATION_LINKS:
    		return getIncomingConversationLinks();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__OUTGOING_CONVERSATION_LINKS:
    		return getOutgoingConversationLinks();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__IS_FOR_COMPENSATION:
    		return isIsForCompensation() ? Boolean.TRUE : Boolean.FALSE;
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__LOOP_CHARACTERISTICS:
    		return getLoopCharacteristics();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__RESOURCES:
    		return getResources();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__DEFAULT:
    		return getDefault();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__PROPERTIES:
    		return getProperties();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__IO_SPECIFICATION:
    		return getIoSpecification();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__BOUNDARY_EVENT_REFS:
    		return getBoundaryEventRefs();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__DATA_INPUT_ASSOCIATIONS:
    		return getDataInputAssociations();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__DATA_OUTPUT_ASSOCIATIONS:
    		return getDataOutputAssociations();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__START_QUANTITY:
    		return new java.lang.Integer(getStartQuantity());
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__COMPLETION_QUANTITY:
    		return new java.lang.Integer(getCompletionQuantity());
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__FLOW_ELEMENTS:
    		return getFlowElements();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__LANE_SETS:
    		return getLaneSets();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__TRIGGERED_BY_EVENT:
    		return isTriggeredByEvent() ? Boolean.TRUE : Boolean.FALSE;
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__ARTIFACTS:
    		return getArtifacts();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__PROTOCOL:
    		return getProtocol();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TRANSACTION__METHOD:
    		return getMethod();
    }
