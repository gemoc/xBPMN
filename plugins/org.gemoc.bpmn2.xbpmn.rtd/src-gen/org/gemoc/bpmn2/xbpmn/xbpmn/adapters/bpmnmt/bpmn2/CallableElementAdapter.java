...
public class CallableElementAdapter extends EObjectAdapter<CallableElement> implements org.obeonetwork.dsl.bpmn2.CallableElement {
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getCallableElement();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALLABLE_ELEMENT__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALLABLE_ELEMENT__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALLABLE_ELEMENT__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALLABLE_ELEMENT__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALLABLE_ELEMENT__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALLABLE_ELEMENT__NAME:
    		return getName();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALLABLE_ELEMENT__IO_SPECIFICATION:
    		return getIoSpecification();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALLABLE_ELEMENT__SUPPORTED_INTERFACE_REFS:
    		return getSupportedInterfaceRefs();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.CALLABLE_ELEMENT__IO_BINDING:
    		return getIoBinding();
    }
