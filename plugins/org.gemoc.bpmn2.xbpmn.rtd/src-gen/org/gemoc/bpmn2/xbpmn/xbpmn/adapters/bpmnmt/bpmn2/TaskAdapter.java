...
public class TaskAdapter extends EObjectAdapter<Task> implements org.obeonetwork.dsl.bpmn2.Task {
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getTask();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__NAME:
    		return getName();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__AUDITING:
    		return getAuditing();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__MONITORING:
    		return getMonitoring();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__CATEGORY_VALUE_REF:
    		return getCategoryValueRef();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__OUTGOING:
    		return getOutgoing();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__INCOMING:
    		return getIncoming();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__LANES:
    		return getLanes();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__INCOMING_CONVERSATION_LINKS:
    		return getIncomingConversationLinks();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__OUTGOING_CONVERSATION_LINKS:
    		return getOutgoingConversationLinks();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__IS_FOR_COMPENSATION:
    		return isIsForCompensation() ? Boolean.TRUE : Boolean.FALSE;
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__LOOP_CHARACTERISTICS:
    		return getLoopCharacteristics();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__RESOURCES:
    		return getResources();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__DEFAULT:
    		return getDefault();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__PROPERTIES:
    		return getProperties();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__IO_SPECIFICATION:
    		return getIoSpecification();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__BOUNDARY_EVENT_REFS:
    		return getBoundaryEventRefs();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__DATA_INPUT_ASSOCIATIONS:
    		return getDataInputAssociations();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__DATA_OUTPUT_ASSOCIATIONS:
    		return getDataOutputAssociations();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__START_QUANTITY:
    		return new java.lang.Integer(getStartQuantity());
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.TASK__COMPLETION_QUANTITY:
