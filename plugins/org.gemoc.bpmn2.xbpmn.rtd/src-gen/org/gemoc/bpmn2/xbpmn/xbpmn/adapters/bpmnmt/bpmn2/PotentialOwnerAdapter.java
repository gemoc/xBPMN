...
public class PotentialOwnerAdapter extends EObjectAdapter<PotentialOwner> implements org.obeonetwork.dsl.bpmn2.PotentialOwner {
  ...
  public EClass eClass() {
    return org.obeonetwork.dsl.bpmn2.Bpmn2Package.eINSTANCE.getPotentialOwner();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.POTENTIAL_OWNER__ID:
    		return getId();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.POTENTIAL_OWNER__EXTENSION_DEFINITIONS:
    		return getExtensionDefinitions();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.POTENTIAL_OWNER__EXTENSION_VALUES:
    		return getExtensionValues();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.POTENTIAL_OWNER__DOCUMENTATION:
    		return getDocumentation();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.POTENTIAL_OWNER__DESCRIPTION:
    		return getDescription();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.POTENTIAL_OWNER__RESOURCE_REF:
    		return getResourceRef();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.POTENTIAL_OWNER__RESOURCE_PARAMETER_BINDINGS:
    		return getResourceParameterBindings();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.POTENTIAL_OWNER__RESOURCE_ASSIGNMENT_EXPRESSION:
    		return getResourceAssignmentExpression();
    	case org.obeonetwork.dsl.bpmn2.Bpmn2Package.POTENTIAL_OWNER__NAME:
    		return getName();
    }
