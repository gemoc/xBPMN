...
/**
 * This is the item provider adapter for a {@link org.gemoc.bpsim2.Calendar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CalendarItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Calendar_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Calendar_value_feature", "_UI_Calendar_type"),
				 Bpsim2Package.Literals.CALENDAR__VALUE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpsim2Package.Literals.CALENDAR__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bpsim2Package.Literals.CALENDAR__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Calendar.class)) {
			case Bpsim2Package.CALENDAR__VALUE:
			case Bpsim2Package.CALENDAR__ID:
			case Bpsim2Package.CALENDAR__NAME:
