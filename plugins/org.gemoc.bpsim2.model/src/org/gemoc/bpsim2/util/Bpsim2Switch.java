 ...
 * @generated
 */
public class Bpsim2Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Bpsim2Package.BETA_DISTRIBUTION_TYPE: {
			...
			case Bpsim2Package.BINOMIAL_DISTRIBUTION_TYPE: {
			...
			case Bpsim2Package.BOOLEAN_PARAMETER_TYPE: {
			...
			case Bpsim2Package.DISTRIBUTION_PARAMETER: {
			...
			case Bpsim2Package.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bpsim2Package.DURATION_PARAMETER_TYPE: {
			...
			case Bpsim2Package.ENUM_PARAMETER_TYPE: {
			...
			case Bpsim2Package.ERLANG_DISTRIBUTION_TYPE: {
			...
			case Bpsim2Package.EXPRESSION_PARAMETER_TYPE: {
			...
			case Bpsim2Package.FLOATING_PARAMETER_TYPE: {
			...
			case Bpsim2Package.GAMMA_DISTRIBUTION_TYPE: {
			...
			case Bpsim2Package.LOG_NORMAL_DISTRIBUTION_TYPE: {
			...
			case Bpsim2Package.NEGATIVE_EXPONENTIAL_DISTRIBUTION_TYPE: {
			...
			case Bpsim2Package.NORMAL_DISTRIBUTION_TYPE: {
			...
			case Bpsim2Package.NUMERIC_PARAMETER_TYPE: {
			...
			case Bpsim2Package.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bpsim2Package.PARAMETER_VALUE: {
				ParameterValue parameterValue = (ParameterValue)theEObject;
				T result = caseParameterValue(parameterValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bpsim2Package.POISSON_DISTRIBUTION_TYPE: {
			...
			case Bpsim2Package.STRING_PARAMETER_TYPE: {
			...
			case Bpsim2Package.TRUNCATED_NORMAL_DISTRIBUTION_TYPE: {
			...
			case Bpsim2Package.UNIFORM_DISTRIBUTION_TYPE: {
			...
			case Bpsim2Package.USER_DISTRIBUTION_DATA_POINT_TYPE: {
			...
			case Bpsim2Package.USER_DISTRIBUTION_TYPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Property Type1</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Property Type1</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePropertyType1(PropertyType1 object) {
		return null;
	}
