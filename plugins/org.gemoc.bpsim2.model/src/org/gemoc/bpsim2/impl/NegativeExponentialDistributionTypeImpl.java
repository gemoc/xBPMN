 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.bpsim2.impl.NegativeExponentialDistributionTypeImpl#getMean <em>Mean</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NegativeExponentialDistributionTypeImpl extends DistributionParameterImpl implements NegativeExponentialDistributionType {
	...
	protected EClass eStaticClass() {
		return Bpsim2Package.Literals.NEGATIVE_EXPONENTIAL_DISTRIBUTION_TYPE;
	}
	...
	public void setMean(double newMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpsim2Package.NEGATIVE_EXPONENTIAL_DISTRIBUTION_TYPE__MEAN, oldMean, mean, !oldMeanESet));
	}
	...
	public void unsetMean() {
		...
		meanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Bpsim2Package.NEGATIVE_EXPONENTIAL_DISTRIBUTION_TYPE__MEAN, oldMean, MEAN_EDEFAULT, oldMeanESet));
	}
