 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.bpsim2.impl.ErlangDistributionTypeImpl#getK <em>K</em>}</li>
 *   <li>{@link org.gemoc.bpsim2.impl.ErlangDistributionTypeImpl#getMean <em>Mean</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErlangDistributionTypeImpl extends DistributionParameterImpl implements ErlangDistributionType {
	...
	protected EClass eStaticClass() {
		return Bpsim2Package.Literals.ERLANG_DISTRIBUTION_TYPE;
	}
	...
	public void setK(double newK) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpsim2Package.ERLANG_DISTRIBUTION_TYPE__K, oldK, k, !oldKESet));
	}
	...
	public void unsetK() {
		...
		kESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Bpsim2Package.ERLANG_DISTRIBUTION_TYPE__K, oldK, K_EDEFAULT, oldKESet));
	}
	...
	public void setMean(double newMean) {
		...
		meanESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpsim2Package.ERLANG_DISTRIBUTION_TYPE__MEAN, oldMean, mean, !oldMeanESet));
	}
	...
	public void unsetMean() {
		...
		meanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Bpsim2Package.ERLANG_DISTRIBUTION_TYPE__MEAN, oldMean, MEAN_EDEFAULT, oldMeanESet));
	}
