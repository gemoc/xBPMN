 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.bpsim2.impl.GammaDistributionTypeImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link org.gemoc.bpsim2.impl.GammaDistributionTypeImpl#getShape <em>Shape</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GammaDistributionTypeImpl extends DistributionParameterImpl implements GammaDistributionType {
	...
	protected EClass eStaticClass() {
		return Bpsim2Package.Literals.GAMMA_DISTRIBUTION_TYPE;
	}
	...
	public void setScale(double newScale) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpsim2Package.GAMMA_DISTRIBUTION_TYPE__SCALE, oldScale, scale, !oldScaleESet));
	}
	...
	public void unsetScale() {
		...
		scaleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Bpsim2Package.GAMMA_DISTRIBUTION_TYPE__SCALE, oldScale, SCALE_EDEFAULT, oldScaleESet));
	}
	...
	public void setShape(double newShape) {
		...
		shapeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpsim2Package.GAMMA_DISTRIBUTION_TYPE__SHAPE, oldShape, shape, !oldShapeESet));
	}
	...
	public void unsetShape() {
		...
		shapeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Bpsim2Package.GAMMA_DISTRIBUTION_TYPE__SHAPE, oldShape, SHAPE_EDEFAULT, oldShapeESet));
	}
