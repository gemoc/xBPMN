 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.bpsim2.impl.EnumParameterTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.gemoc.bpsim2.impl.EnumParameterTypeImpl#getParameterValueGroup <em>Parameter Value Group</em>}</li>
 *   <li>{@link org.gemoc.bpsim2.impl.EnumParameterTypeImpl#getParameterValue <em>Parameter Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumParameterTypeImpl extends ParameterValueImpl implements EnumParameterType {
	...
	protected EClass eStaticClass() {
		return Bpsim2Package.Literals.ENUM_PARAMETER_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, Bpsim2Package.ENUM_PARAMETER_TYPE__GROUP);
		}
		return group;
	}
	...
	public FeatureMap getParameterValueGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(Bpsim2Package.Literals.ENUM_PARAMETER_TYPE__PARAMETER_VALUE_GROUP);
	}
	...
	public EList<ParameterValue> getParameterValue() {
		return getParameterValueGroup().list(Bpsim2Package.Literals.ENUM_PARAMETER_TYPE__PARAMETER_VALUE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case Bpsim2Package.ENUM_PARAMETER_TYPE__PARAMETER_VALUE_GROUP:
				return ((InternalEList<?>)getParameterValueGroup()).basicRemove(otherEnd, msgs);
			case Bpsim2Package.ENUM_PARAMETER_TYPE__PARAMETER_VALUE:
