 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.bpsim2.impl.UserDistributionTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.gemoc.bpsim2.impl.UserDistributionTypeImpl#getUserDistributionDataPoint <em>User Distribution Data Point</em>}</li>
 *   <li>{@link org.gemoc.bpsim2.impl.UserDistributionTypeImpl#isDiscrete <em>Discrete</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserDistributionTypeImpl extends DistributionParameterImpl implements UserDistributionType {
	...
	protected EClass eStaticClass() {
		return Bpsim2Package.Literals.USER_DISTRIBUTION_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, Bpsim2Package.USER_DISTRIBUTION_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<UserDistributionDataPointType> getUserDistributionDataPoint() {
		return getGroup().list(Bpsim2Package.Literals.USER_DISTRIBUTION_TYPE__USER_DISTRIBUTION_DATA_POINT);
	}
	...
	public void setDiscrete(boolean newDiscrete) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpsim2Package.USER_DISTRIBUTION_TYPE__DISCRETE, oldDiscrete, discrete, !oldDiscreteESet));
	}
	...
	public void unsetDiscrete() {
		...
		discreteESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Bpsim2Package.USER_DISTRIBUTION_TYPE__DISCRETE, oldDiscrete, DISCRETE_EDEFAULT, oldDiscreteESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Bpsim2Package.USER_DISTRIBUTION_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case Bpsim2Package.USER_DISTRIBUTION_TYPE__USER_DISTRIBUTION_DATA_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Bpsim2Package.USER_DISTRIBUTION_TYPE__DISCRETE:
				return isDiscrete();
		}
