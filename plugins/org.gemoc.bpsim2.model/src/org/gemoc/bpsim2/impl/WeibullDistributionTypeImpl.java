 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.bpsim2.impl.WeibullDistributionTypeImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link org.gemoc.bpsim2.impl.WeibullDistributionTypeImpl#getShape <em>Shape</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WeibullDistributionTypeImpl extends DistributionParameterImpl implements WeibullDistributionType {
	...
	protected EClass eStaticClass() {
		return Bpsim2Package.Literals.WEIBULL_DISTRIBUTION_TYPE;
	}
	...
	public void setScale(double newScale) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpsim2Package.WEIBULL_DISTRIBUTION_TYPE__SCALE, oldScale, scale, !oldScaleESet));
	}
	...
	public void unsetScale() {
		...
		scaleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Bpsim2Package.WEIBULL_DISTRIBUTION_TYPE__SCALE, oldScale, SCALE_EDEFAULT, oldScaleESet));
	}
	...
	public void setShape(double newShape) {
		...
		shapeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpsim2Package.WEIBULL_DISTRIBUTION_TYPE__SHAPE, oldShape, shape, !oldShapeESet));
	}
	...
	public void unsetShape() {
		...
		shapeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Bpsim2Package.WEIBULL_DISTRIBUTION_TYPE__SHAPE, oldShape, SHAPE_EDEFAULT, oldShapeESet));
	}
