 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.bpsim2.impl.PoissonDistributionTypeImpl#getMean <em>Mean</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PoissonDistributionTypeImpl extends DistributionParameterImpl implements PoissonDistributionType {
	...
	protected EClass eStaticClass() {
		return Bpsim2Package.Literals.POISSON_DISTRIBUTION_TYPE;
	}
	...
	public void setMean(double newMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpsim2Package.POISSON_DISTRIBUTION_TYPE__MEAN, oldMean, mean, !oldMeanESet));
	}
	...
	public void unsetMean() {
		...
		meanESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Bpsim2Package.POISSON_DISTRIBUTION_TYPE__MEAN, oldMean, MEAN_EDEFAULT, oldMeanESet));
	}
